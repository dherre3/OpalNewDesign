...
myApp.controller('StatusController',['$rootScope','$scope','$timeout', 'UserPlanWorkflow','$anchorScroll','$location',function($rootScope,$scope,$timeout, UserPlanWorkflow,$anchorScroll,$location){
    ...
    function initTreatmentPlanStatus(){
      ...
      if(stages.length==0){
          ...
          if(nextStageIndex==stages.length){
              ...
              var circle2 = new ProgressBar.Circle('#progressStatusPastStages2', {
                  color: startColor,
                  duration: 2000,
                  easing: 'easeInOut',
                  strokeWidth: 5,
          ...
          var circle = new ProgressBar.Circle('#progressStatusPresentStage2', {
              color: endColor,
              duration: 2000,
              easing: 'easeInOut',
              strokeWidth: 5,
...
myApp.controller('IndividualStepController',['$scope','$timeout',function($scope,$timeout){
  //Enter code here!!
